    ...
    <div class="menu">
    	<div class="wrapper">
                <ul>
                    ...
                    <li><a href="about_hearing.html" style="border-left:1px solid #B3D9FF;">ABOUT HEARING</a></li>
                    <li><a href="hearing_loss.html">HEARING LOSS</a></li>
                    <li><a href="hearing_focus.html">HEARING FOCUS</a></li>
									</li>
                </ul-->
        </div>
    </div>
        ...
        <!--div class="swiper-container hero-slider">
            <div class="swiper-wrapper"-->
                <div class="swiper-slide hero-content-wrap" style="background-image: url('images/hear1.jpg')">
                    <div class="hero-content-overlay position-absolute w-100 h-100">
                            ...
                            <div class="row h-100">
                                <div class="col-12 col-lg-10 d-flex flex-column justify-content-center align-items-start">
                                    <header class="entry-header">
                                        <h1>Audiometry</h1>
                                        <h3> Enjoy Listening Everyday</h3>
                        ...
                        <a class="button gradient-bg" href="hearing_loss.html">Hearing Loss</a>
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="foot-about">
                            ...
                            <p>Enjoy Listening Every Day.</p>

                            <p class="copyright"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Privacy policy  </a>
